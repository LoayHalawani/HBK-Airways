...
function validate(e) {
  ...
  if (daysDepartDate - daysReturnDate >= -2) {
    alert(
      "At least two days must be between your departure date and return date"
    );
    e.preventDefault();
  }
}
...
function roundTrip() {
  ...
  form.action = "../../server/php/roundTripResults.php";
}
...
function oneWay() {
  ...
  form.action = "../../server/php/onewayResults.php";
}
